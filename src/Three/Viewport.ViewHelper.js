...
class ViewHelper extends THREE.Object3D {
    ...
    constructor(editorCamera, container) {
        ...
        panel.dom.id = 'viewHelper';
        panel.dom.style.background = 'red';
        panel.dom.style.position = 'absolute';
        panel.dom.style.right = 0;
        panel.dom.style.bottom = 0;
        // panel.dom.style.width = '128px';
        // panel.dom.style.height = '128px';
